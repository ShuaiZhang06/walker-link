...
## Marks 1-5 are the starter's original route; 6-8 cross Section 03: 1052 over
## the spiked step, 1200 up onto the high stone, 1294 the stone -> the far
...
var jump_marks: Array[float] = [138.0, 292.0, 424.0, 548.0, 712.0, 1052.0, 1200.0, 1294.0]
var next_jump: int = 0
